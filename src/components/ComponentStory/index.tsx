...
import { AnchorButton, Cluster, IntlProvider, Loader, OpenInNewTabIcon, TabBar, TabItem, TextLink } from 'smarthr-ui';
    ...
    <IntlProvider locale="ja">
      <div className={clsx(!noMargin && styles.storyWrapper)}>
        <Cluster align="center" justify="space-between" gap={1}>
          ...
          <Cluster>
            <AnchorButton href={storybookUrl.toString()} target="_blank" size="s" suffix={<OpenInNewTabIcon />} rel="noreferrer">
              Storybook
            </AnchorButton>
            <AnchorButton href={githubUrl.toString()} target="_blank" size="s" suffix={<OpenInNewTabIcon />} rel="noreferrer">
              GitHub
            </AnchorButton>
          </Cluster>
        </Cluster>
