...
order: 1
---
import { Th, Td } from 'smarthr-ui'
import { Table, UsabilityCheckListWarning } from './_components'
...
<tr>
    <Td>1</Td>
    <Td>[情報設計](/products/information-architecture/)</Td>
    <Td>[ユーザーの業務](/products/information-architecture/ia-outputs/user-operations-description/)を説明する</Td>
    <Td>[達成基準1](#h4-0)</Td>
...
<tr>
    <Td>2</Td>
    <Td>[情報設計](/products/information-architecture/)</Td>
    <Td>[概念モデル](/products/information-architecture/ia-outputs/conceptual-model/)を説明する</Td>
    <Td>[達成基準1](#h4-0)</Td>
    <Td>`UOp-7-S 情報の理解可能な分類`</Td>
    <Td>運用操作性</Td>
</tr>
<tr>
    <Td>3</Td>
    <Td>[情報設計](/products/information-architecture/)</Td>
    <Td>[オブジェクトモデル](/products/information-architecture/ia-outputs/object-model/)を説明する</Td>
    <Td>[達成基準1](#h4-0)</Td>
    <Td>`UOp-7-S 情報の理解可能な分類`</Td>
    <Td>運用操作性</Td>
</tr>
<tr>
    <Td>4</Td>
    <Td>[情報設計](/products/information-architecture/)</Td>
    <Td>[ビューの呼び出し関係](/products/information-architecture/ia-outputs/view-relationship-diagram/)を説明する</Td>
    <Td>[達成基準1](#h4-0)</Td>
    <Td>`UOp-7-S 情報の理解可能な分類`</Td>
    <Td>運用操作性</Td>
</tr>
<tr>
    <Td>5</Td>
    <Td>[情報設計](/products/information-architecture/)</Td>
    <Td>[メインナビゲーション](/products/information-architecture/ia-outputs/main-navigation/)を説明する</Td>
    <Td>[達成基準1](#h4-0)</Td>
    <Td>`UOp-7-S 情報の理解可能な分類`</Td>
    <Td>運用操作性</Td>
</tr>
...
<tr>
    <Td>22</Td>
    <Td>アクセシビリティ</Td>
    <Td>[アクセシビリティガイドライン](/accessibility/guidelines/)を用いてデザインファイルをチェックしたか</Td>
    <Td>[達成基準2](#h4-1)</Td>
...
#### 1. 情報設計カテゴリの達成基準
- [情報設計のアウトプット](/products/information-architecture/ia-outputs/)を作成していること
- 対象となる開発プロジェクトは、[情報設計レビュー](/products/usability/ia-review/)を実施していること
...
- 対象となる開発プロジェクトは、[UIレビュー](/products/usability/ui-review/)を実施していること
