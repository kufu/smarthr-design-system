...
RadioButtonと同様に、RadioButtonPanelは常に1つの選択肢が選択されているコンポーネントのため、選択肢の中から1つデフォルト値に設定するものを決めてください。（参考：[コンポーネントごとのデフォルト値](/products/design-patterns/default_value/#h3-0)）

ユーザーの混乱を避けるため、項目の並び順やライティングを調整して1つ目の選択肢がデフォルトになるようにしてください。

![RadioButtonPanelで1つ目の選択肢がデフォルトになっているイメージ](./images/radio-button-panel_default-value.png)
...
<Checklist name="RadioButtonPanel" />
