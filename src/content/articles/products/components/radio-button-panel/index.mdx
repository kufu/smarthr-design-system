...
RadioButtonと同様に、RadioButtonPanelは常に1つの選択肢が選択されているコンポーネントのため、選択肢のうちの1つをデフォルト値に設定します。（参考：[デフォルト値に設定する値](/products/design-patterns/default_value/#h3-1)）

![RadioButtonPanelにデフォルト値が設定されているイメージ](./images/radio-button-panel_default-value.png)
