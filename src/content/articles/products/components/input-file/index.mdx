...
## 使用上の注意
### 選択すべきファイルの内容や種類の説明
- InputFileはラベルが必要なコンポーネントです。[FormControl](/products/components/form-control/)のtitleを使用して、ユーザーが選択すべきファイルを説明するラベルを設定してください。
- 特定のファイルを扱うダイアログ内での利用など、コンテキストが明確で説明的なラベルが冗長となる場合には、helpMessageを使用して、入力すべきファイルを特定する説明を提供してください。
