...
<DoAndDont type="dont" width="calc(50% - 8px)">
  <Image slot="img" src={formControlErrorSampleDont} alt="証明書の種類を選択するSelectと並んだラベルのないInputFile" />
  <Text slot="label">ファイル選択するファイルを明示していない場合、ユーザーが誤ったデータを入力する危険性があります。</Text>
</DoAndDont>
