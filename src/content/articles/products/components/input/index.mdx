...
import {SampleInputWithPrefixIcon, SampleInputWithSuffixIcon} from './_components'
...
- [エラーなどの重要な通知は操作部の近くで表示する | 弱視・ロービジョンのユーザビリティチェックリスト](/accessibility/insight/low-vision-check-list/notification-proximity/)
