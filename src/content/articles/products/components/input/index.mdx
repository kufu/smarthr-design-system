...
- [エラーの発生とエラーの内容が特定できる | アクセシビリティガイドライン](/accessibility/check-list/error/)
- [入力欄や選択肢を選択、または入力したときに大きな変化を起こさない | アクセシビリティガイドライン](/accessibility/check-list/consistent-behavior/)
