...
ユーザーの入力作業が向上したり、ミスを減らせる場合には他の値をデフォルトで設定することを検討します。（参考：[デフォルト値](/products/design-patterns/default_value/)）

![radiobuttonに「未選択」の選択肢があるイメージ](./images/radio-button-unselected-option.png)
