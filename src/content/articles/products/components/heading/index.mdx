...
見出し要素の代替として直後のコンテンツの見出しを示すコンポーネントです。「[セクション](/products/design-patterns/section-block-pattern/)」や「[ブロック](/products/design-patterns/section-block-pattern/)」に見出しをつけるときに使います。
