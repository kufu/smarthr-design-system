...
description: '予期しないエラーが発生したことを表示する全画面コンポーネントです。Auth/Forbidden/NotFound/Unauthorizedの各ErrorScreen以外の予期しないエラーを全画面で伝えるときに使います。'
---
import ComponentPropsTable from '@/components/article/ComponentPropsTable.astro'
import ComponentStory from '@/components/article/ComponentStory.astro'

予期しないエラーが発生したことを表示する全画面コンポーネントです。Auth/Forbidden/NotFound/Unauthorizedの各ErrorScreen以外の予期しないエラーを全画面で伝えるときに使います。
