...
姓名や期間の開始・終了のように値を分割して入力する場合や、[Checkbox](/products/components/checkbox/)や[RadioButton](/products/components/radio-button/)といった複数の入力要素を持つフォームに対してラベルやメッセージテキストを表示したい場合に適しています。
