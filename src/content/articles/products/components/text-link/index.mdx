...
import { OpenInNewTabIcon} from 'smarthr-ui'
...
- TextLinkは、**テキストの右側**に <OpenInNewTabIcon alt="新規ウィンドウ" color="TEXT_LINK" /> アイコン（`OpenInNewTabIcon`）を自動で配置するため、個別に設定する必要はありません。
