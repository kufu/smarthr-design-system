...
import { OpenInNewTabIconInTextLink } from './_components'
...
リンクテキストは、リンク先や実行される内容がわかる文言にしてください。
リンク先がわからない曖昧なテキストは、ユーザーがリンクの目的を理解しづらくなり、意図したページへ移動できるか判断しにくくなる場合があります。

詳しい書き方や例については、[リンクのテキストからリンク先が判別できる](/accessibility/check-list/link-text/)の達成方法を参照してください。

### 関連ページ

- [リンクテキストからリンク先が判別できる | アクセシビリティガイドライン](/accessibility/check-list/link-text/)
- [リンクテキストに下線がある | 弱視・ロービジョンのユーザビリティチェックリスト](/accessibility/low-vision-check-list/link-underline/)

## 使い方チェックリスト

<Checklist name="TextLink" />
