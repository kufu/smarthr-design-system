...
フィードバックには[NotificationBar](/products/components/notification-bar/)や[ResponseMessage](/products/components/response-message/)などを使います。詳しくは、[フィードバック](/products/design-patterns/feedback/)を参照してください。
