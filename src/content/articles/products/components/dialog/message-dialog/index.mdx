...
import imageMessageDialogSheet from '../images/message_dialog_mobile_sheet.png'
...
<BaseColumn>
  <ResponseMessage type="info">シート形式のMessageDialogは、propsに追加する形でsmarthr-uiに実装予定です。</ResponseMessage>
</BaseColumn>
...
<Cluster gap={1}>
  ...
  <DoAndDont type="do" width="calc(50% - 8px)">
    <Image slot="img" src={imageMessageDialogSheet} alt="Do" />
