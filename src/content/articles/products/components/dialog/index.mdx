...
<ComponentPropsTable name="DialogWrapper" showTitle />

<ComponentPropsTable name="DialogTrigger" showTitle />

<ComponentPropsTable name="DialogContent" showTitle />

<ComponentPropsTable name="DialogCloser" showTitle />
