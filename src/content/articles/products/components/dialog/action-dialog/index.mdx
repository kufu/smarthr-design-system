---
title: 'ActionDialog'
description: 'ユーザーに確認や単純な操作を求めるためのダイアログコンポーネントです。フォーム要素を含まない確認・実行のダイアログを表示するときに使います。フォーム要素を含む場合はFormDialogを使います。'
---
...
ユーザーに確認や単純な操作を求めるためのダイアログコンポーネントです。フォーム要素を含まない確認・実行のダイアログを表示するときに使います。フォーム要素を含む場合は[FormDialog](/products/components/dialog/form-dialog/)を使います。
