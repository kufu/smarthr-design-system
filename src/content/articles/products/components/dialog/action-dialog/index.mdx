...
モバイルでは、通常のアクションダイアログに加えて、拡大アクションダイアログを使用できます。

### 表示する情報量に応じて拡大アクションダイアログが使用できる
...
<Cluster gap={1}>
  ...
  <DoAndDont type="do" width="calc(50% - 8px)">
    ...
    <Text slot="label">モバイルで表示する情報量が多い場合に拡大アクションダイアログで表示する</Text>
  </DoAndDont>
</Cluster>
...
![拡大アクションダイアログの余白の説明図](../images/explain_expanded_action_dialog_mobile.png)
...
![SubActionAreaを表示した拡大アクションダイアログの例](../images/expanded_action_dialog_mobile_sub_action_area.png)
