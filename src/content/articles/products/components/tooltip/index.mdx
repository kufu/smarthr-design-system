...
import { TextAndIcon, IconOnly, TextWithIcon, StatusSupplement, IconButton, EllipsisText } from './_components/Examples'
...
- [hoverで表示されるコンテンツはポインタを乗せても表示を維持できる](/accessibility/low-vision-check-list/hover/)
