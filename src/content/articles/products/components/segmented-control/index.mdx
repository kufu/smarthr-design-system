...
import { Groupbox, Cluster, Text } from 'smarthr-ui'
import { Dont, DoWithWrap, DoWithReel } from './_components'

<Cluster gap={{ row: 0, column: 1 }}>
  <DoAndDont type="dont" width={320}>
    <Groupbox slot="img" as="figure" aria-labelledby="caption1" style={{ display: 'flex', alignItems: 'center', margin: 'unset', minHeight: '6rem' }}>
      <Dont />
    </Groupbox>
  ...
  <Cluster gap={{ row: 0, column: 1 }}>
    <DoAndDont type="do" width={320}>
      <Groupbox slot="img" as="figure" aria-labelledby="caption2" style={{ display: 'flex', alignItems: 'center', margin: 'unset', minHeight: '6rem' }}>
        <DoWithWrap />
      </Groupbox>
...
<Checklist name="SegmentedControl" />
