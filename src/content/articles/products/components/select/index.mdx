...
#### FormControlと併用する
Selectコンポーネントは、[FormControl](/products/components/form-control/)コンポーネントと併用して、選択項目の内容を示すラベルを設定してください。

これにより、ラベルとSelectが関連付けられ、スクリーンリーダーを使用するユーザーにも、何を選択するための項目なのかが伝わります。
