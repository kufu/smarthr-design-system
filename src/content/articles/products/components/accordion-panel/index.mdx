...
description: 'コンテンツの表示・非表示を切り替えるための展開パネル型のコンポーネントです。コンテンツが多い場合に一部を隠して表示するときに使います。'
---
import ComponentStory from '@/components/article/ComponentStory.astro'
import ComponentPropsTable from '@/components/article/ComponentPropsTable.astro'

コンテンツの表示・非表示を切り替えるための展開パネル型のコンポーネントです。コンテンツが多い場合に一部を隠して表示するときに使います。  
...
モードレスに情報を表示したい場合、AccordionPanelの代替として[ModelessDialog](/products/components/dialog/modeless-dialog/)を使用できます。  
