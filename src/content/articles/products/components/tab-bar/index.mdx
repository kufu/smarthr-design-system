---
title: 'TabBar'
description: '異なるオブジェクトやビューを横方向のタブで切り替えるためのコンポーネントです。同一ページ内で並列関係にあるビューを切り替えるとき、影響範囲を下線などで明確にしながらタブを並べるときに使います。'
---
...
異なるオブジェクトやビューを横方向のタブで切り替えるためのコンポーネントです。同一ページ内で並列関係にあるビューを切り替えるとき、影響範囲を下線などで明確にしながらタブを並べるときに使います。
