...
import { Groupbox, Text } from 'smarthr-ui'
...
<DoAndDont type="do" width={320}>
  <Groupbox slot="img" as="figure" aria-labelledby="caption" style={{ display: 'flex', alignItems: 'center', margin: 'unset', minHeight: '6rem' }}>
    <TabBarWithReel />
  </Groupbox>
...
![タブバーとPanelが並んでいる](./images/tab-bar-stretched.png)

## 使い方チェックリスト

<Checklist name="TabBar" />
