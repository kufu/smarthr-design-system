...
AppHeaderは、[Header](#h3-0)と[AppNavi](#h3-1)によって構成されます。
...
```tsx editable canvas=1400 hideCode background=BACKGROUND
<AppHeader
  appName="勤怠管理"
  currentTenantId="tenant-1"
  desktopAdditionalContent={<span>デスクトップの追加コンテンツ</span>}
  desktopNavigationAdditionalContent={<span>デスクトップのナビゲーション追加コンテンツ</span>}
  features={[
    {
      favorite: false,
      id: 'feature-1',
  ...
  locale={{
    onSelectLocale: function uDe(){}
  }}
  mobileAdditionalContent={<p>モバイルの追加コンテンツ</span>}
  navigations={[
    {
      children: 'aタグ',
    ...
    {
      children: 'カスタムタグ',
      elementAs: function uDe(){},
      to: 'https://example.com'
    },
    {
      children: 'ボタン',
      onClick: function uDe(){}
    },
    {
      childNavigations: [
        {
