---
title: 'AppHeader'
description: 'ページ上部に配置するSmartHR共通ヘッダーコンポーネントです。HeaderとAppNaviを結合し、表示要素を固定化することで各アプリケーションの表示を共通化します。'
---
import ComponentPropsTable from '@/components/article/ComponentPropsTable.astro'
import ComponentStory from '@/components/article/ComponentStory.astro'

ページ上部に配置するSmartHR共通ヘッダーコンポーネントです。[Header](/products/components/header/)と[AppNavi](/products/components/app-navi/)を結合し、表示要素を固定化することで各アプリケーションの表示を共通化します。
