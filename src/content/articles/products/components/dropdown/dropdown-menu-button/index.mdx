...
description: '1つのボタンに関連する複数の操作をまとめてリスト表示するメニューボタンコンポーネントです。編集・複製・削除など、オブジェクトに対する複数アクションをまとめるときに使います。'
---
...
1つのボタンに関連する複数の操作をまとめてリスト表示するメニューボタンコンポーネントです。編集・複製・削除など、オブジェクトに対する複数アクションをまとめるときに使います。
