...
- [7-1. 入力する内容や、操作がラベルとして表示されている | アクセシビリティガイドライン | SmartHR Design System](/accessibility/guidelines/label/)
- [7-2. フォームパーツにアクセシブルネームがある | アクセシビリティガイドライン | SmartHR Design System](/accessibility/guidelines/accessible-name/)
