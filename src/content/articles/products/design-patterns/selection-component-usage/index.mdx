...
| [Checkbox](/products/components/checkbox/) | **複数** | 送信時 | 5個以下 | なし | 例外として[チェックボックスを二択の切り替え入力に使用できる場合](/products/components/check-box/#h4-4)があります。 |
...
<BaseColumn className="shr-mt-2" padding={{ block: 1, inline: 1.5 }}>
  <Stack gap={0.25}>
    ...
    <Text as="p">
      提供までに検索機能よりモバイルでの操作性を優先する場合は、代替として[Select](/products/components/select/)または[Checkbox](/products/components/check-box/)を使用してください。
    </Text>
  </Stack>
</BaseColumn>
