...
<BaseColumn>
  <ResponseMessage type="info">よくあるリストを実現しやすくするための、Listコンポーネントをsmarthr-uiで実装予定です。</ResponseMessage>
</BaseColumn>
...
<BaseColumn>
  <ResponseMessage type="info">Listコンポーネントをsmarthr-uiで実装予定です。</ResponseMessage>
</BaseColumn>
