...
`よくあるリスト`が主に想定しているモバイル環境では画面の幅が狭いことから、 表示できるボタンは**[通常サイズのアイコンボタン](/products/components/button/#h4-1)1つです**。複数の操作を表示したい場合は、[DropdownMenuButton](/products/components/dropdown/dropdown-menu-button/)を使います。
