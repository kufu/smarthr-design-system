...
<Grid>
    <ImgWithDesc description="よくあるテーブルのテーブル">
    ![スクリーンショット: よくあるテーブルのテーブル](./images/smarthr-table-conversion-table.png)
    </ImgWithDesc>
    <ImgWithDesc description="よくあるリストのリスト">
    ![スクリーンショット: よくあるリストのリスト](./images/smarthr-list-conversion-table.png)
    </ImgWithDesc>
</Grid>
