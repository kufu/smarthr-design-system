...
矩形や罫線を利用したグルーピングでは、使用する色によってグルーピングの効果が十分に得られない場合があります。特に背景色と要素の境界のコントラストが低いと、視覚的な区切りが曖昧になり、情報のまとまりを認識しにくくなります。
グルーピングを明確にするためには、十分なコントラスト比を確保するか、余白や見出しなどの手がかりも併用することを推奨します。
