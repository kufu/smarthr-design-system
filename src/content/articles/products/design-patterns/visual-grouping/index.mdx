...
矩形は[Panel](/products/components/panel/)や[GroupBox](/products/components/group-box/)を用いて表現できます。
...
コンテンツは基本的に余白でグルーピングしますが、以下のようにまとまりを示しづらい場合には[GroupBox](/products/components/group-box/)を使い、矩形により明確に領域を示すこともできます。
