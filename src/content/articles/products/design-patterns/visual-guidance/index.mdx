...
視線誘導の法則を活用したレイアウトだけでなく、[アクセシビリティガイドライン](/accessibility/guidelines/)や、[弱視・ロービジョンのユーザビリティチェックリスト](/accessibility/insight/low-vision-check-list/)に対応するなど、目に見える情報だけに頼らないUI設計も検討する必要があります。
...
- [画面の左側に見出しやUIを配置する](/accessibility/insight/low-vision-check-list/left-layout/)
- [関連するフォームパーツは隣り合う位置に配置する](/accessibility/insight/low-vision-check-list/adjacent-fields/)
