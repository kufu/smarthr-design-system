...
{<span id="replace-okonau-with-suru" />}
## 「○○する」「○○してください」などと表記し、「○○を行う」の使用は控える
### 説明
「行う」は冗長な表現になりやすいため、可能な場合は「○○する」「○○してください」などの表記に置き換えてください。

### 置き換えが難しい場合
置き換えが難しい場合は「行う」と表記してください。「行なう」は使用しません。  
「行う」は義務教育で学習する表記であることから、「行う」を使用する判断をしました。
...
https://www.notion.so/UXW-34337b6398eb81028b39d8905d548048#34a37b6398eb801f84e9cb545a07b216
