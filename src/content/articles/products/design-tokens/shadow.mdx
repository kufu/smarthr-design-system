...
| `LAYER3` | 0 4px 8px 2px [`TRANSPARENCY_30`](/products/design-tokens/color/#h3-6) | [BottomFixedArea](/products/components/bottom-fixed-area/)（上方向）<br />[Calendar](/products/components/calendar/)<br />[CompactInformationPanel](/products/components/compact-information-panel/)<br />[Dropdown](/products/components/dropdown/)<br />[FloatArea](/products/components/float-area/)<br />[InformationPanel](/products/components/information-panel/) |
