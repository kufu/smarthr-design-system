...
グラフで使用する色を定めています。グラフには指定された順序で色を使用します。

#### 多色のグラフ

<ColorPalettesWrapper>
  <ColorPalette colorValue="rgb(0, 196, 204)" colorName="CHART_COLOR_1" description="多色チャート色1" />
  <ColorPalette colorValue="rgb(255, 145, 0)" colorName="CHART_COLOR_2" description="多色チャート色2" />
  <ColorPalette colorValue="rgb(45, 125, 240)" colorName="CHART_COLOR_3" description="多色チャート色3" />
  <ColorPalette colorValue="rgb(5, 135, 140)" colorName="CHART_COLOR_4" description="多色チャート色4" />
  <ColorPalette colorValue="rgb(0, 90, 100)" colorName="CHART_COLOR_5" description="多色チャート色5" />
</ColorPalettesWrapper>
