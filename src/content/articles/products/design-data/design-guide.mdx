...
具体的な使用方法は、[デザインデータ（Figma）の更新をライブラリに適用する手順](/products/design-data/figma-library-update/)を参照してください。
...
| アイコン | Icon/Fa + アイコン名（パスカルケース）※ | ***Icon/FaCircleInfo*** |
...
基本的に[Reactコンポーネントの名称や構造](https://github.com/kufu/smarthr-ui/tree/master/packages/smarthr-ui/src/components)と一致させます。
