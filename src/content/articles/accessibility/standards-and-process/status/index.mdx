...
情報アクセシビリティ自己評価様式は、企業などが製品やサービスについてアクセシビリティの自己評価を行うための様式です。
...
- [入社・招待時に雇用契約を行う](./entrance-procedures/#h2-2)
...
- [2要素認証の設定を行う](./personal-settings/#h2-1)
...
- [氏名変更の手続きを行う](./procedure/#h2-2)
- [住所変更の手続きを行う](./procedure/#h2-3)
