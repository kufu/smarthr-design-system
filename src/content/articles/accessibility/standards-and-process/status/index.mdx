...
## 情報アクセシビリティ自己評価様式
### 情報アクセシビリティ自己評価様式の開示
総務省の情報アクセシビリティ自己評価様式を使用して、製品の評価をしています。
情報アクセシビリティ自己評価様式は、企業などが製品やサービスについてアクセシビリティの自己評価をするための様式です。
参考：[総務省 情報アクセシビリティ自己評価様式の普及促進](https://www.soumu.go.jp/info-accessibility-portal/b-free/jikohyoukayoshiki/case/)
...
- 勤怠管理機能：[情報アクセシビリティ好事例2025](https://www.soumu.go.jp/info-accessibility-portal/koujirei/2025/)
...
### 勤怠管理機能
- [2025_勤怠管理機能_情報アクセシビリティ自己評価様式（書式１ 自己評価結果）](https://docs.google.com/spreadsheets/d/1TdgQ5L8plOrSHkrLPhlCPB-thyFlyyiJ/edit?usp=drive_link&ouid=105803662496200081471&rtpof=true&sd=true)
- [2025_勤怠管理機能_情報アクセシビリティ自己評価様式（書式２ 技術基準）](https://docs.google.com/spreadsheets/d/1R39dHOdgPi0TR26NDx7FPfRbDvFDrcXg/edit?usp=drive_link&ouid=105803662496200081471&rtpof=true&sd=true)


## アクセシビリティ検証結果一覧

各機能のプロセスごとに、WCAG達成基準や[アクセシビリティガイドライン](/accessibility/guidelines/)に基づくチェック、支援技術で利用可能であるかを検証しています。
## [入社手続き・雇用契約](./entrance-procedures/)
### 試験を行ったシナリオ
- [招待メールから入社手続きをする](./entrance-procedures/#h2-0)
- [通知用メールアドレスを登録する](./entrance-procedures/#h2-1)
- [入社・招待時に雇用契約をする](./entrance-procedures/#h2-2)
...
- [2要素認証の設定をする](./personal-settings/#h2-1)
...
- [氏名変更の手続きをする](./procedure/#h2-2)
- [住所変更の手続きをする](./procedure/#h2-3)
