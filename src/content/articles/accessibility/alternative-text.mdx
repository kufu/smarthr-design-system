                ...
                <dl style={{ marginLeft: '2em' }}>
                  ...
                  <dd>
                    <figure style={{ margin: 0 }}>
                      ...
                      <figcaption style={{ marginTop: '20px' }}>アイコンはテキストラベルと同じ意味を表している。</figcaption>
                    </figure>
                  </dd>
                </dl>
              </li>
                ...
                <dl style={{ marginLeft: '2em' }}>
                  ...
                  <dd>
                    <figure style={{ margin: 0 }}>
                      ...
                      <figcaption style={{ marginTop: '20px' }}>１つ目のチェックマークは「編集済み」、２つ目のエクスクラメーションは「エラー発生」、３つ目の下向き三角は「クリックで展開すること」を示唆しており、テキストラベルでは提示していない情報を単独で持っている。</figcaption>
                    </figure>
                  </dd>
                </dl>
              </li>
