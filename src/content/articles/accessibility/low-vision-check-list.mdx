...
内容には、弱視・ロービジョンのユーザーに特に影響のある[ウェブアクセシビリティ簡易チェックリスト](./check-list/)の一部項目を含みます。
...
- [画面を200%拡大、または文字サイズを2倍に変更しても情報が取得できる](./check-list/browser-zoom/)
- [リンクのテキストからリンク先が判別できる](./check-list/link-text/)
...
- [背景色と文字色のコントラスト比が4.5:1（大きな文字: 29px以上は3:1）以上ある](./check-list/color-contrast/)
- [色や、形、音、レイアウト情報のみでコンテンツを説明していない](./check-list/content-description/)
...
- [エラーの発生とエラーの内容が特定できる](./check-list/error/)
- [入力欄や選択肢を選択、または入力したときに大きな変化を起こさない](./check-list/input-change/)
