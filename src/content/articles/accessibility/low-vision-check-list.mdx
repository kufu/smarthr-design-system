...
内容には、弱視・ロービジョンのユーザーに特に影響のある[ウェブアクセシビリティ簡易チェックリスト](https://smarthr.design/accessibility/check-list/)の一部項目を含みます。
...
- [背景色と文字色のコントラスト比が4.5:1（大きな文字: 29px以上は3:1）以上ある](./color-contrast/)
- [色や、形、音、レイアウト情報のみでコンテンツを説明していない](./content-description/)
...
- [入力欄や選択肢を選択、または入力したときに大きな変化を起こさない](./input-change/)
