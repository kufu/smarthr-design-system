...
内容には、弱視・ロービジョンのユーザーに特に影響のある[アクセシビリティガイドライン](/accessibility/guidelines/)の一部項目を含みます。

## 1. レイアウト

1. [同一の操作や説明には一貫したアイコンを使用する](./consistent-icon/)
2. [リンクテキストに下線がある](./link-underline/)
3. [文字画像を使用しない](./images-of-text/)
4. [画面の左側に見出しやUIを配置する](./left-layout/)
5. [関連するフォームパーツは隣り合う位置に配置する](./adjacent-fields/)

アクセシビリティガイドライン

- [画面を200%拡大、または文字サイズを2倍に変更しても情報が取得できる](/accessibility/guidelines/browser-zoom/)
- [リンクのテキストからリンク先が判別できる](/accessibility/guidelines/link-text/)
...
2. [色のみで領域やグループを表現しない](/accessibility/insight/low-vision-check-list/grouping/)

アクセシビリティガイドライン

- [背景色と文字色のコントラスト比が4.5:1（大きな文字: 29px以上は3:1）以上ある](/accessibility/guidelines/contrast/)
- [色や、形、音、レイアウト情報のみでコンテンツを説明していない](/accessibility/guidelines/sensory-characteristics/)
...
1. [hoverで表示されるコンテンツはポインタを乗せても表示を維持できる](/accessibility/insight/low-vision-check-list/hover/)
2. [クリックやタップができる領域を広くする](/accessibility/insight/low-vision-check-list/target-size/)
3. [エラーなどの重要な通知は操作部の近くで表示する](/accessibility/insight/low-vision-check-list/notification-proximity)

アクセシビリティガイドライン

- [エラーの発生とエラーの内容が特定できる](/accessibility/guidelines/error/)
- [入力欄や選択肢を選択、または入力したときに大きな変化を起こさない](/accessibility/guidelines/consistent-behavior/)
