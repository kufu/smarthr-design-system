...
## 概要
この基準では、エラーメッセージや確認などの重要な通知が、操作した要素の近くに表示されることを確認してください。
...
## 達成方法
1. **入力時のエラー表示**:
    - 入力要素からフォーカスが外れたタイミングで、入力要素の付近にエラーメッセージを表示します。
...
## テスト方法
1. **目視での確認**:
    - フォームの送信やボタンのクリックなど、通知が発生する操作を行います。
    - 表示される通知（エラーメッセージ、確認メッセージなど）が、操作を行った要素の近くに表示されていることを確認します。
