...
| --- | --- | --- | --- |
| キャプチャ中央部省略用 | ![省略線-center-image](./images/kit/省略線_center_image.png)　|![省略線-center-example](./images/kit/center_example_image.png)　| [パソコンサイズ](/images/kit/省略線_パソコンサイズ_center.png) / <a href="/images/kit/省略線_スマートフォンサイズ_center.png" target="_blank">スマートフォンサイズ</a> | 
