...
| --- | --- | --- | --- |
| キャプチャ中央部省略用 | ![省略線-center-image](./images/kit/省略線_center_image.png)　|![省略線-center-example](./images/kit/center_example_image.png)　| <a href="./images/kit/省略線_パソコンサイズ_center.png" target="_blank">パソコン</a> / <a href="./images/kit/省略線_スマートフォンサイズ_center.png" target="_blank">スマートフォン</a> | 
| キャプチャ下部省略用 | ![省略線-bottom-image](./images/kit/省略線_bottom_image.png)　|![省略線-bottom-example](./images/kit/bottom_example_image.png)　| <a href="./images/kit/省略線_パソコンサイズ_bottom.png" target="_blank">パソコン</a> / <a href="./images/kit/省略線_スマートフォンサイズ_bottom.png" target="_blank">スマートフォン</a> | 
| キャプチャ上部省略用 | ![省略線-top-image](./images/kit/省略線_top_image.png)　|![省略線-top-example](./images/kit/top_example_image.png)　|<a href="./images/kit/省略線_パソコンサイズ_top.png" target="_blank">パソコン</a> / <a href="./images/kit/省略線_スマートフォンサイズ_top.png" target="_blank">スマートフォン</a> | 


![省略線-center-image](./images/kit/省略線_center_image.png)
