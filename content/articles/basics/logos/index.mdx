...
<Grid>
  ...
  <ImgWithDesc description="ロゴの書体を変えてはいけない">

  ![ロゴの書体を変更した画像に、斜線が引かれている](./images/logo_ng_font.png)

  </ImgWithDesc>

  <ImgWithDesc description="アイソレーションの領域を超えて要素を配置してはいけない">
  ...
  <ImgWithDesc description="シンボルを単体で使ってはいけない">

  ![シンボルのみを配置した画像に、斜線が引かれている](./images/logo_ng_symbol.png)
