...
![hogehoge](./images/service-cartegory-logo_image.png)
...
![hogehoge](./images/service-category-logo_architecture.png)
...
<Grid>
  ...
  ![hogehoge](./images/SmartHR-logo_image.png)
...
<Grid>
  ...
  ![hogehoge](./images/service-category-logo_vertical-horizontal.png)
...
![hogehoge](./images/service-category-logo_isolation.png)
...
<Grid>
  ...
  ![hogehoge](./images/service-category-logo_isolation_primary-color.png)
...
<Grid>
  ...
  ![hogehoge](./images/service-category-logo_isolation_secondary-color.png)
...
![hogehoge](./images/service-category-logo_background.png)
...
<Grid>
  ...
  ![hogehoge](./images/service-category-logo_ng-1.png)

  </ImgWithDesc>

  <ImgWithDesc description="組み合わせのサイズや位置を変更してはいけない">

  ![hogehoge](./images/service-category-logo_ng-2.png)

  </ImgWithDesc>
  
  <ImgWithDesc description="定義されたカテゴリー以外を独断で作成してはいけない">

  ![hogehoge](./images/service-category-logo_ng-3.png)

  </ImgWithDesc>
    
  <ImgWithDesc description="指定カラー以外で表記してはいけない">

  ![hogehoge](./images/service-category-logo_ng-4.png)

  </ImgWithDesc>
    
  <ImgWithDesc description="ロゴマークを追加してはいけない">

  ![hogehoge](./images/service-category-logo_ng-5.png)
</Grid>
