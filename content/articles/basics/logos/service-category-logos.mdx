...
サービスSmartHRは、サービスブランド「SmartHR」の配下に「SmartHR 労務管理」「SmartHR タレントマネジメント」という
領域単位の2つのブランドを保有しています。この領域を示すロゴを「サービスカテゴリーロゴ」と呼称しています。
...
<Grid>
  ...
  ![SmartHR Blueのロゴ](./images/service-cartegory-logo_SmartHR-logo_image.png)
...
[SmartHR Design System内のロゴの禁止事項](/logos/#h3-5)に加えて、サービスカテゴリーロゴの適切な認知を担保するために以下の表現を避けて利用してください。
...
<a href="/downloads/SmartHR_meta.zip">サービスカテゴリーロゴ データ一式</a>
