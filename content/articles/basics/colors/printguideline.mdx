...
![カラーチップと銀色の封筒を並べたセットの様子](./images/printguideline/colorchip_spec.png)
...
<ImgWithDesc description="①コート紙（加工なし）  6枚">
  ...
  ![①コート紙（加工なし）の画像。適度に光沢があり、発色がよい](./images/printguideline/colorchip_coat.png)
...
<Grid>
  ...
  ![②コート紙（ニス加工）の画像。①よりもやや光沢感が強く、ごくわずかに黄味がかっている](./images/printguideline/colorchip_coatNisu.png)

  </ImgWithDesc>

  <ImgWithDesc description="③コート紙（グロスPP加工）  2枚">

  ![③コート紙（グロスPP加工）の画像。①より大幅に光沢感があり平滑で発色感がある](./images/printguideline/colorchip_coatGrossPP.png)

  </ImgWithDesc>

  <ImgWithDesc description="④コート紙（マットPP加工）  2枚　">

  ![④コート紙（マットPP加工）の画像。①よりややマットな質感で、ごくわずかに黄味がかっている](./images/printguideline/colorchip_coatMatPP.png)

  </ImgWithDesc>

  <ImgWithDesc description="⑤マットコート紙  2枚">

  ![⑤マットコート紙の画像。①より全体がマットで質感を持っており、インク面のみうっすら光沢がある](./images/printguideline/colorchip_matCoat.png)

  </ImgWithDesc>

  <ImgWithDesc description="⑥上質紙  2枚">

  ![⑥上質紙の画像。①より全体にマットで沈んだような発色。ノートのような紙質](./images/printguideline/colorchip_joshitsu.png)

  </ImgWithDesc>

  <ImgWithDesc description="⑦クラフト紙  2枚">

  ![⑦クラフト紙の画像。ダンボールの表面のような茶色で、インクは沈んで発色は悪い](./images/printguideline/colorchip_craft.png)
...
- カラーチップの一部を切り取って共有できます。  
 ...
 ![カラーチップの一部を切り取っている画像。カラーチップを手に取りハサミでカットしている](./images/printguideline/colorchip_scene01.png)

### 色校正の確認をする際に使用する
- 色校正を確認する際に、カラーチップと比較しながら色合いを検証できます。

 ![カラーチップと印刷物を比較している画像。比較したい印刷物の上にカラーチップを乗せて、色味を見比べている](./images/printguideline/colorchip_scene02.png)
