...
### プロダクトのUI例
  ...
  <ImgWithDesc description="SmartHR UIを利用できます。配色もそのままよいです。">

  ![](../images/app_ui_ok1.png)

  </ImgWithDesc>

  <ImgWithDesc description="SmartHR UIを利用できます。配色を変更してもよいです。">

  ![](../images/app_ui_ok2.png)

  </ImgWithDesc>

  <ImgWithDesc description="SmartHR UIの利用を推奨しますが、利用しなくてもよいです。">

  ![](../images/app_ui_ok2-1.png)
...
<Grid>
  ...
  ![](../images/app_lp_ng1.png)

  </ImgWithDesc>

  <ImgWithDesc description="SmartHR Blueの近似値をメインとした配色">

  ![](../images/app_lp_ng2.png)
