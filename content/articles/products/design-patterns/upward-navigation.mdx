...
[SmartHR基本機能の共通設定](/products/design-patterns/main-admin/)のように、メインコンテンツにサイドナビゲーションが隣接する場合は、<FaArrowLeftIcon visuallyHiddenText="左矢印" color="TEXT_LINK" size={16} /> アイコンをメインコンテンツの左端に合わせて配置します。
