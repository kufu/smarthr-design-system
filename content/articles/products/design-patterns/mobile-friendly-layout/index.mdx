...
<Cluster gap={1}>
  <DoAndDont
    type="dont"
    img={
      <BaseColumn as="figure" aria-labelledby="caption1" style={{ display: 'flex', margin: 'unset', gap: '1em' }}>
        <Base padding={1.5} style={{ flexShrink: 0, flexBasis: '25%' }}>
          <Stack gap={0.5}>
        ...
        <Base padding={1.5} style={{ flexGrow: 1 }}>
          <Stack>
  ...
  <DoAndDont
    type="do"
    img={
      <BaseColumn as="figure" aria-labelledby="caption2" style={{ display: 'flex', flexWrap: 'wrap', margin: 'unset', gap: '1em' }}>
        <Base padding={1.5}>
          <Stack gap={0.5}>
            <Heading type="blockTitle" tag="span" style={{ fontSize: '1rem', lineHeight: 1.25, marginBlockStart: 0 }}>複数カラムレイアウトを避ける</Heading>
            <p style={{ lineHeight: 1.5 }}>折り返しの多すぎるコンテンツの理解は難しいです。</p>
