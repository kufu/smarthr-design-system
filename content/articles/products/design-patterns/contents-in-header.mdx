...
![ヘッダーの構成](./images/contents-in-header/header-anatomy.png)
...
![グローバルヘッダーの構成](./images/contents-in-header/global-header-anatomy.png)
...
![グローバルヘッダーにSmartHRロゴを配置した例](./images/contents-in-header/smarthrlogo.png)
...
![ヘルプボタン](./images/contents-in-header/help-button.png)
...
![閉じた状態のアプリランチャー](./images/contents-in-header/app-launcher.png)

アプリランチャーを押すと、アプリケーションのリンクがカテゴリ別にグルーピングされたドロップダウンが表示されます。

![開いた状態のアプリランチャー](./images/contents-in-header/opened-app-launcher-in-global-header.png)
...
![アプリナビゲーションの構成](./images/contents-in-header/app-navigation-anatomy.png)
...
![機能名](./images/contents-in-header/app-name.png)
...
![アプリナビゲーションボタンの構成](./images/contents-in-header/app-navigation-button.png)
...
![データ同期ボタン](./images/contents-in-header/data-sync-button.png)
...
![閉じた状態のリリースノートボタン](./images/contents-in-header/release-note-button.png)

リリースノートボタンを押すと、最新5件分の日付を含むリリースノートへのリンクと、対応するアプリケーションのリリースノートの一覧画面へ移動するリンクが表示されます。  

![開いた状態のリリースノートボタン](./images/contents-in-header/opened-release-note-button-in-app-navigation.png)
