...
ユーザーが利用できるSmartHR内の他の機能へ移動するためのボタンです。  

原則として、他の機能とあわせて横断的に利用するユースケースが想定される場合に配置します。
...
SmartHR基本機能の従業員情報や共通設定に登録されているデータを、現在アクセスしている機能のデータベースへ能動的に同期するためのボタンです。  
...
現在アクセスしている機能のリリースノートを確認するためのボタンです。  
...
リリースノートボタンを押すと、最新5件分の日付を含むリリースノートへのリンクと、対応する機能のリリースノートの一覧画面へ移動するリンクが表示されます。  
