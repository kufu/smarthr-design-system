...
複数の選択肢から1つを選択する場合は、表示領域に余裕がある場合は[RadioButton](/products/components/radio-button/)、項目数が多い場合や表示領域が狭い場合などは[Select](/products/components/select/)や[ComboBox](/products/components/combo-box/)の使用を検討してください。
