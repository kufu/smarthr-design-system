...
## デフォルト値
選択肢があらかじめ選ばれている状態を想定する場合は、[デフォルト値](/products/design-patterns/default_value/)を参照してください。


### デフォルト値がユーザーの意図しない選択肢の場合
何も選択していない状態を示すために「選択してください。」を選択肢に追加してください。

![selectに「選択してください。」の選択肢があるイメージ](./images/select-unselected-option.png)
