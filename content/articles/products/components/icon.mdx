...
| [ヘルプセンター](https://knowledge.smarthr.jp/hc/ja)を開くテキストリンク | **テキストの左側**に <FaQuestionCircleIcon alt="ヘルプセンター" color="TEXT_LINK" /> アイコン（`FaQuestionCircleIcon`）を配置（推奨） | 詳細は[ヘルプページへの動線](/products/design-patterns/help-link/#h3-2)を参照してください。 |
