...
### アイコンの位置
AccordionPanelは、`iconPosition` props によってアイコンの位置を左または右に指定できます。開閉する機能をアイコンによって認識しやすくするため、原則見出しの左にアイコンを置いてください。  
アイコンと見出しの位置が離れAccordionPanelとして認識しづらくなるため、右に配置するのは非推奨です。
