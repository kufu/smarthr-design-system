...
| `AUTO` | auto |  |
| `DEFALUT` | 0 |  |
| `FIXED_MENU` | 100 | [BottomFixedArea](/products/components/bottom-fixed-area/)<br />[RightFixedNote](/products/components/right-fixed-note/)<br />[thead](/products/components/table/)（`fixedHead={true}`） |
