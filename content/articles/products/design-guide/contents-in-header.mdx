...
- ロゴの表示には、[SmartHRLogo](/products/components/smarthr-logo/)を使用します。
- ロゴを利用する際は、[基本原則](/foundations/basic/logo/)のガイドラインに準拠します。
...
- テキストリンクの左に「<FaQuestionCircleIcon visuallyHiddenText="ヘルプ" size={16} />」アイコン（`fa-question-circle`）を配置します。
