...
| icon | ComponentType<Omit<Pick<VariantProps<any>, "contentBgColor"> & { contentPadding?: any; className?: string; } & Pick<DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement>, "ref"> & { ...; } & { ...; } & { ...; }, "heading" \| "closeButton" \| "handleClickClose" \| "actionButton" \| "handleClickAction"> & { total: number; current: number; padding?: number; withoutNumbers?: boolean; } & ControlledProps & PortalProps & { ...; } & Omit<...>> | - | - | 表示するアイコンタイプ |
