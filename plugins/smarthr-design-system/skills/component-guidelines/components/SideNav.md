...
| onClick | (e: MouseEvent<HTMLButtonElement, MouseEvent>) => void | - | - | アイテムを押下したときに発火するコールバック関数 |
...
| onClick | (e: MouseEvent<HTMLAnchorElement, MouseEvent>) => void | - | - | アイテムを押下したときに発火するコールバック関数 |
