---
name: base
description: "smarthr-ui の baseClassNameGenerator / Base を使うとき、props を選ぶとき、関連するアクセシビリティ・デザインシステムのルールを確認するとき、コンポーネントの組み合わせを判断するときに使う。矩形で視覚的に要素をグルーピングするコンポーネントです。"
metadata:
  version: "1.0.0"
...
```ts
import { baseClassNameGenerator, Base } from 'smarthr-ui'
```

## Props

### baseClassNameGenerator
| Props 名 | 型 | デフォルト値 | 必須 | 説明 |
|---|---|---|---|---|
| radius | "s" \| "m" | - | - | - |
| paddingBlock | Gap | - | - | - |
| paddingInline | Gap | - | - | - |
| overflowBlock | "hidden" \| "clip" \| "auto" \| "visible" \| "scroll" | - | - | - |
| overflowInline | "hidden" \| "clip" \| "auto" \| "visible" \| "scroll" | - | - | - |
| layer | 0 \| 1 \| 2 \| 3 \| 4 | - | - | - |
