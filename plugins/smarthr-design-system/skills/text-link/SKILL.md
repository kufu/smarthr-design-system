---
name: text-link
description: "テキストにリンクを付けるとき、アンカー要素をデザインシステム準拠で使うとき、props を選ぶとき、関連するアクセシビリティ・デザインシステムのルールを確認するときに使う。aタグの代わりに使用するコンポーネントです。前後にアイコンを差し込めます。またリンクであることを表すために下線を強制します。"
metadata:
  version: "1.0.0"
