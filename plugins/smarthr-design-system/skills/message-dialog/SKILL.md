---
name: message-dialog
description: "メッセージや情報をダイアログで通知するとき、props を選ぶとき、関連するアクセシビリティ・デザインシステムのルールを確認するときに使う。ユーザーに情報を提示するためのダイアログコンポーネントです。入力などの操作を伴わずにメッセージや情報をダイアログで提示するときに使います。"
metadata:
  version: "1.0.0"
