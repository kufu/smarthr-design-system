---
name: currency-input
description: "金額・通貨を入力させるとき、props を選ぶとき、関連するアクセシビリティ・デザインシステムのルールを確認するときに使う。金額を入力させるためのコンポーネントです。給与・税額など金額値を入力させるときに使います。"
metadata:
  version: "1.0.0"
...
金額を入力させるためのコンポーネントです。給与・税額など金額値を入力させるときに使います。
