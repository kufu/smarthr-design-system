...
```bash
# Button
grep -n "^## アクセシビリティ" src/content/articles/products/components/button/index.mdx
Read src/content/articles/products/components/button/index.mdx offset={開始行} limit=50

# Table
grep -n "^## アクセシビリティ" src/content/articles/products/components/table/index.mdx
Read src/content/articles/products/components/table/index.mdx offset={開始行} limit=50
```
