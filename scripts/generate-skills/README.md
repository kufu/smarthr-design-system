...
```sh
rm scripts/generate-skills/eslint-rules-snapshot.json
GITHUB_TOKEN=<token> pnpm --filter ./scripts/generate-skills generate   # API から取得し直しスナップショットを更新
```
